...
dbRouter.get('/wc2', function (req, res, next) {
    categories_model_1.default.find().maxTimeMS(30000)
        .then(result1 => {
        subCategories_model_1.SubCatModel.find().maxTimeMS(30000)
...
dbRouter.get('/wc3', async function (req, res, next) {
    try {
        ...
        var result = (0, copyToDB_1.writeOrg1)("מקומות עבודה ציבוריים", "אתרי ממשלה", json);
