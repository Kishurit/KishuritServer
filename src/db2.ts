...
const dbConnectionString = process.env.MONGU_URI;
...
const connectToDatabase2 = async (): Promise<Mongoose> => {
  try {
...
const db2: Connection = mongoose.connection;
...
export { connectToDatabase2, db2 as default };
